...
load("results/new_2y/models_2level/models_train.RData")
...
write.csv(all_metrics, 
          "results/new_2y/models_2level/key_metrics.csv", 
          row.names = FALSE)

cat("Results saved to: results/new_2y/models_2level/key_metrics.csv\n\n")
