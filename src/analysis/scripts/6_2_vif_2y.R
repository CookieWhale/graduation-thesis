...
load("results/new_2y/models_2level/models_full.RData")
...
dir.create("results/new_2y/models_2level/vif", showWarnings = FALSE, recursive = TRUE)
...
diagnose_vif <- function(model_obj, model_name) {
  ...
  write.csv(as.data.frame(vif_values), 
            paste0("results/new_2y/models_2level/vif/", model_name, "_VIF.csv"),
            row.names = FALSE)
  
  cat("VIF results saved to: results/new_2y/models_2level/vif/", model_name, "_VIF.csv\n\n")
...
write.csv(vif_comparison,
          "results/new_2y/models_2level/vif/vif_summary.csv",
          row.names = FALSE)

save(vif_m1, vif_m2,
     file = "results/new_2y/models_2level/vif/vif_results.RData")
...
cat("Generated files:\n")
cat("  results/new_2y/models_2level/vif/Model1_Triggered_vs_Temporary_VIF.csv\n")
cat("  results/new_2y/models_2level/vif/Model2_Sustained_vs_Terminated_VIF.csv\n")
cat("  results/new_2y/models_2level/vif/vif_summary.csv\n")
cat("  results/new_2y/models_2level/vif/vif_results.RData\n\n")
