...
n_final <- nrow(dataset_trimmed_6m)
...
if(!dir.exists("data/new_6m")) dir.create("data/new_6m", recursive = TRUE)

save(dataset_trimmed_6m, file = "data/new_6m/dataset_trimmed_6m.RData")

cat("\nProcessed data saved to: data/new_6m/dataset_trimmed_6m.RData\n")

summary_check <- dataset_trimmed_6m %>%
