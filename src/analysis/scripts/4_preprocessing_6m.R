...
compute_correlation <- function(data, vars, subset_name) {
  ...
  pdf(paste0("results/new_6m/correlation_", gsub(" ", "_", tolower(subset_name)), ".pdf"), 
      width = 10, height = 10)
  corrplot(cor_matrix, 
           method = "color",
           type = "upper",
...
write.csv(cor_model1, "results/new_6m/correlation_model1.csv", row.names = TRUE)
write.csv(cor_model2, "results/new_6m/correlation_model2.csv", row.names = TRUE)
...
save(df_preprocessed, file = "data/new_6m/preprocessed_full.RData")
cat("Saved: data/new_6m/preprocessed_full.RData\n")

save(df_train, file = "data/new_6m/preprocessed_train.RData")
cat("Saved: data/new_6m/preprocessed_train.RData\n")

save(df_test, file = "data/new_6m/preprocessed_test.RData")
cat("Saved: data/new_6m/preprocessed_test.RData\n")

save(scaling_params, file = "data/new_6m/scaling_params.RData")
cat("Saved: data/new_6m/scaling_params.RData\n")

save(train_hackathons, file = "data/new_6m/train_hackathons.RData")
cat("Saved: data/new_6m/train_hackathons.RData\n")
...
write.csv(preprocessing_summary, 
          "results/new_6m/preprocessing_summary.csv",
          row.names = FALSE)
...
write.csv(variable_list,
          "results/new_6m/variable_list.csv",
          row.names = FALSE)
...
cat("Generated files:\n")
cat("Data files:\n")
cat("  data/new_6m/preprocessed_full.RData\n")
cat("  data/new_6m/preprocessed_train.RData\n")
cat("  data/new_6m/preprocessed_test.RData\n")
cat("  data/new_6m/scaling_params.RData\n")
cat("  data/new_6m/train_hackathons.RData\n")
cat("\nResult files:\n")
cat("  results/new_6m/correlation_model1.csv\n")
cat("  results/new_6m/correlation_model1.pdf\n")
cat("  results/new_6m/correlation_model2.csv\n")
cat("  results/new_6m/correlation_model2.pdf\n")
cat("  results/new_6m/preprocessing_summary.csv\n")
cat("  results/new_6m/variable_list.csv\n")
