...
load("data/new_6m/preprocessed_train.RData")
...
dir.create("results/new_6m/models_2level", showWarnings = FALSE, recursive = TRUE)

save(m1_main_full, m2_main_full, 
     file = "results/new_6m/models_2level/models_full.RData")

save(m1_main_train, m2_main_train,
     file = "results/new_6m/models_2level/models_train.RData")
...
write.csv(all_coefs, "results/new_6m/models_2level/coefficients_all.csv", row.names = FALSE)
...
write.csv(all_random, "results/new_6m/models_2level/random_effects.csv", row.names = FALSE)

all_fit_stats <- bind_rows(
  results_m1_main_full$fit_stats,
  results_m2_main_full$fit_stats
)
write.csv(all_fit_stats, "results/new_6m/models_2level/model_fit_stats.csv", row.names = FALSE)
