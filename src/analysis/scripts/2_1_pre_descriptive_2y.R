...
write.csv(stats_full$cont_stats, 
          "results/new_2y/descriptive_stats_full.csv", 
          row.names = FALSE)

write.csv(stats_model1$cont_stats, 
          "results/new_2y/descriptive_stats_model1.csv", 
          row.names = FALSE)

write.csv(stats_model2$cont_stats, 
          "results/new_2y/descriptive_stats_model2.csv", 
          row.names = FALSE)

write.csv(comparison_table,
          "results/new_2y/descriptive_stats_comparison.csv",
          row.names = FALSE)
...
write.csv(outcome_summary,
          "results/new_2y/outcome_distribution.csv",
          row.names = FALSE)
...
write.csv(sample_size_summary,
          "results/new_2y/sample_size_summary.csv",
          row.names = FALSE)
...
cat("\nResults saved to results/new_2y/ folder:\n")
